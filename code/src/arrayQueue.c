...
// I have commented all approaches except OMP Atomic
...
/*++++++++++++++++++++++++++++++++++++ For Normal operation & Push(shared queue) ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
/*__u32 shared_q_tail_next = shared_q->tail_next;
	shared_q->tail_next += local_q->tail;*/
...
/*	__u32 temp = __sync_fetch_and_add(&(q->tail),1);
	__sync_bool_compare_and_swap(&(q->queue[temp]),q->queue[temp],k);
	q->tail_next = __sync_fetch_and_add(&(q->tail),0);*/
